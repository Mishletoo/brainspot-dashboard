...
export default function RegisterPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const status = linkResult?.status as string | undefined;
    ...
    if (status === "conflict" || status === "email_mismatch") {
      await supabase.auth.signOut();
      setErrorMessage(
        "This email cannot be linked to your account. Please contact your administrator."
      );
      setIsSubmitting(false);
      return;
    }

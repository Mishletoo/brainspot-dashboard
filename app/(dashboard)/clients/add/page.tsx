...
export default function AddClientPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl text-[var(--color-bs-text)]">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-[var(--color-bs-text)]">Добавяне на клиент</h1>
        <p className="mt-1 text-sm text-[var(--color-bs-muted)]">Създайте нов клиент, като попълните формата.</p>
      </div>
